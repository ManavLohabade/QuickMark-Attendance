...
CREATE TABLE public.degrees (
    degree_id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(255) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX idx_degree_departments_degree ON public.degree_departments USING btree (degree_id);
CREATE INDEX idx_degree_departments_department ON public.degree_departments USING btree (department_id);
